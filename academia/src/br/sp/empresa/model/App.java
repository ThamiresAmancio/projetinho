...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println("Situação:" + alana.getStatusImc());
		...
		System.out.println("Situaçao: " + alice.getStatusImc());
		...
		emanuel.setNivelAtividade("Intermediário");
		...
		System.out.println("Situação:" + emanuel.getStatusImc());
		...
		erick.setNivelAtividade("Avançado");
		...
		System.out.println("Situação:" + erick.getStatusImc());
